...
class AboutSubCommand extends BaseSubCommand
{
    ...
    {
        $message = TextFormat::GREEN . "PiggyCustomEnchants version " . TextFormat::GOLD . $this->getPlugin()->getDescription()->getVersion() . TextFormat::EOL .
        ...
        if ($sender instanceof Player && $this->getPlugin()->areFormsEnabled()) {
            $form = new SimpleForm(function (Player $player, ?int $data): void {
                if ($data !== null) {
                    $this->getPlugin()->getServer()->dispatchCommand($player, "ce");
                }
            });
